...
async function getAccessToken() {
    ...
    try {
        ...
        throw new Error(`Failed to obtain access token: ${axiosError.message}`);
    }
}
...
const tools = [
    // Identities
    {
        ...
        description: "List identities in SailPoint with optional filtering. Returns identity ID, name, email, lifecycle state, and manager information.",
        inputSchema: {
            type: "object",
            properties: {
                limit: {
                ...
                filters: {
                    type: "string",
                    description: "Filter expression (e.g., 'name co \"John\"' or 'lifecycleState eq \"active\"')",
                },
                sorters: {
                    type: "string",
    ...
    {
        name: "get_identity",
        description: "Get detailed information about a specific identity by ID, including attributes, accounts, and access.",
        inputSchema: {
            type: "object",
            properties: {
                id: {
    ...
    {
        name: "list_accounts",
        description: "List accounts across all sources with filtering options. Returns account ID, name, source, identity owner, and status.",
        inputSchema: {
            type: "object",
            properties: {
                limit: {
                ...
                filters: {
                    type: "string",
                    description: "Filter expression (e.g., 'sourceId eq \"abc123\"' or 'disabled eq true')",
                },
                sorters: {
                    type: "string",
    ...
    {
        name: "get_account",
        description: "Get detailed information about a specific account including attributes and entitlements.",
        inputSchema: {
            type: "object",
            properties: {
                id: {
    ...
    // Access Profiles
    {
        ...
        description: "List access profiles with optional filtering. Access profiles bundle entitlements for role-based access.",
        inputSchema: {
            type: "object",
            properties: {
                limit: {
    ...
    },
    {
        ...
        description: "Get detailed information about a specific access profile including entitlements.",
        inputSchema: {
            type: "object",
            properties: {
                id: {
    ...
    {
        name: "list_roles",
        description: "List roles with optional filtering. Roles bundle access profiles and entitlements for business functions.",
        inputSchema: {
            type: "object",
            properties: {
                limit: {
    ...
    {
        name: "get_role",
        description: "Get detailed information about a specific role including access profiles and memberships.",
        inputSchema: {
            type: "object",
            properties: {
                id: {
    ...
    // Certifications
    {
        ...
        description: "List active certification reviews. Certifications are access review campaigns.",
        inputSchema: {
            type: "object",
            properties: {
                limit: {
    ...
    },
    {
        ...
        description: "Get detailed information about a specific certification including items to review.",
        inputSchema: {
            type: "object",
            properties: {
                id: {
    ...
    },
    {
        ...
        description: "Get detailed information about a certification campaign including statistics.",
        inputSchema: {
            type: "object",
            properties: {
                id: {
    ...
    {
        name: "get_workflow",
        description: "Get detailed information about a specific workflow including steps and triggers.",
        inputSchema: {
            type: "object",
            properties: {
                id: {
    ...
    {
        name: "list_sources",
        description: "List connected sources (identity repositories). Sources are the systems SailPoint connects to.",
        inputSchema: {
            type: "object",
            properties: {
                limit: {
                ...
                filters: {
                    type: "string",
                    description: "Filter expression (e.g., 'type eq \"Active Directory\"')",
                },
                sorters: {
                    type: "string",
                    description: "Sort fields",
    ...
    {
        name: "get_source",
        description: "Get detailed information about a specific source including connection status.",
        inputSchema: {
            type: "object",
            properties: {
                id: {
    ...
    {
        name: "search",
        description: "Perform a search across identities, accounts, access profiles, roles, or entitlements using query syntax.",
        inputSchema: {
            type: "object",
            properties: {
                indices: {
                ...
                query: {
                    type: "string",
                    description: "Search query string (e.g., 'name:John AND department:Engineering')",
                },
                queryType: {
                    type: "string",
    ...
    },
    {
        ...
        description: "Perform aggregate queries on search indices for analytics (counts, groupings, etc.).",
        inputSchema: {
            type: "object",
            properties: {
                indices: {
                ...
                aggregationField: {
                    type: "string",
                    description: "Field to aggregate on (e.g., 'department', 'source.name')",
                },
                limit: {
                    type: "number",
    ...
    // Entitlements
    {
        ...
        description: "List entitlements (permissions/privileges) across sources.",
        inputSchema: {
            type: "object",
            properties: {
                limit: {
                ...
                filters: {
                    type: "string",
                    description: "Filter expression (e.g., 'source.id eq \"abc123\"')",
                },
                sorters: {
                    type: "string",
                    description: "Sort fields",
    ...
    // Access Requests
    {
        ...
        inputSchema: {
            ...
            properties: {
                ...
                filters: {
                    type: "string",
                    description: "Filter expression (e.g., 'status eq \"PENDING\"')",
                },
                limit: {
                    type: "number",
                    description: "Maximum number of results",
    ...
    },
    {
        ...
        description: "Create a new access request for roles, access profiles, or entitlements.",
        inputSchema: {
            type: "object",
            properties: {
                requestedFor: {
    ...
    // Identity Profiles
    {
        ...
        description: "List identity profiles (configurations for how identities are created/managed).",
        inputSchema: {
            type: "object",
            properties: {
                limit: {
    ...
    },
    {
        ...
        description: "Get detailed information about an identity profile including attribute mappings.",
        inputSchema: {
            type: "object",
            properties: {
                id: {
    ...
    // SOD Policies
    {
        ...
        description: "List Separation of Duties (SOD) policies for compliance monitoring.",
        inputSchema: {
            type: "object",
            properties: {
                limit: {
...
async function handleTool(name, args) {
    ...
    switch (name) {
        ...
        case "create_access_profile": {
            ...
            if (args.requestable !== undefined)
                body.requestable = args.requestable;
            if (args.entitlementIds) {
                body.entitlements = args.entitlementIds.map((id) => ({
                    id,
                    type: "ENTITLEMENT",
                }));
            }
        ...
        case "create_role": {
            ...
            if (args.accessProfileIds) {
                body.accessProfiles = args.accessProfileIds.map((id) => ({
                    id,
                    type: "ACCESS_PROFILE",
                }));
            }
        ...
        case "search": {
            ...
            if (args.sort)
                body.sort = args.sort;
            if (args.searchAfter)
                body.searchAfter = args.searchAfter;
            const params = {};
            if (args.limit)
                params.limit = args.limit;
            params.count = true;
        ...
        case "list_access_requests": {
            ...
            if (args.requestedFor)
                params["requested-for"] = args.requestedFor;
            if (args.requestedBy)
                params["requested-by"] = args.requestedBy;
            if (args.filters)
                params.filters = args.filters;
            if (args.limit)
                params.limit = args.limit;
